...
Both scripts require [CIF](https://github.com/wri/cities-cif) and its associated dependencies--including Google and AWS credentials.
Additionally, get_store_distancerasters.py requires...
