...
* The script _save_cif_boxes.py_ stores bboxes in GEE for each of the target cities. It should be downloaded to your local computer, modified to specify your cities of interest, and run.
